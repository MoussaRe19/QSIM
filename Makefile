...
HEADERS   = fel.h event.h context.h kernel.h entity.h entity_queue.h mm1_state.h mm1_handlers.h mm1_init.h
...
OBJS      = $(patsubst %.o,$(BUILD_DIR)/%.o,\
            ...
            dispatch.o prng.o dist.o entity.o entity_queue.o mm1_handlers.o mm1_init.o)
